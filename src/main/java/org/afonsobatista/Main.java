...
public class Main {
	...
	private enum Command {
		...
		OBJECTS("- Tells you every object you can find at the location your in."), SELL("<item name> <person name> - Sells an item to another person."), 
